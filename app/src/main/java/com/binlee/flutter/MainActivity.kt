...
class MainActivity : AppCompatActivity(), ExclusiveAppComponent<MainActivity> {
  ...
  private fun addFlutterView() {
    ...
    viewEngine?.attachActivity(this as ExclusiveAppComponent<ComponentActivity>)
  ...
  override fun onUserLeaveHint() {
    ...
    override fun getAppComponent(): MainActivity = this
